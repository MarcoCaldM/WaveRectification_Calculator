...
def graph(thetas):
    ...
    #thetas = np.arrange(0,95,5)

    #Debido a que se necesita de que thetas sea un array de 2 o mas variables, 
    #se le agrega el valor de None para asginar al menos dos valores
    ...
    ax1.annotate('Instituto Tecnológico de Chihuahua', 
    ...
    mplcursors.cursor(hover=True)  # Añadir interactividad a la primera gráfica
    plt.show()
    ...
    ax2.annotate('Autores: Marco A. Calderón M. y Alejandro Morales H.', 
                xy=(1, 1), xycoords='axes fraction', 
                fontsize=12, ha='right', va='bottom')
    ax2.annotate('Instituto Tecnológico de Chihuahua', 
                xy=(0, 1), xycoords='axes fraction', 
                fontsize=12, ha='left', va='bottom')
    ...
    ax3.annotate('Autores: Marco A. Calderón M. y Alejandro Morales H.', 
                xy=(1, 1), xycoords='axes fraction', 
                fontsize=12, ha='right', va='bottom')
    ax3.annotate('Instituto Tecnológico de Chihuahua', 
                xy=(0, 1), xycoords='axes fraction', 
                fontsize=12, ha='left', va='bottom')
