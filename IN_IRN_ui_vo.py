...
theta_label_txt.grid(row=12, column=0, padx=10, sticky="we")

beta_label_txt = ttk.Label(root, text="Beta:", style="Modern.TLabel")
beta_label_txt.grid(row=13, column=0, padx=10, sticky="we")

gamma_label_txt = ttk.Label(root, text="Gamma:", style="Modern.TLabel")
gamma_label_txt.grid(row=14, column=0, padx=10, sticky="we")

in_label_txt = ttk.Label(root, text="In:", style="Modern.TLabel")
in_label_txt.grid(row=15, column=0, padx=10, sticky="we")

irn_label_txt = ttk.Label(root, text="Irn:", style="Modern.TLabel")
irn_label_txt.grid(row=16, column=0, padx=10, sticky="we")

io_avg_label_txt = ttk.Label(root, text="Io Avg:", style="Modern.TLabel")
io_avg_label_txt.grid(row=17, column=0, padx=10, sticky="we")

io_rms_label_txt = ttk.Label(root, text="Io RMS:", style="Modern.TLabel")
io_rms_label_txt.grid(row=18, column=0, padx=10, sticky="we")

vo_avg_label_txt = ttk.Label(root, text="Vo Avg:", style="Modern.TLabel")
vo_avg_label_txt.grid(row=19, column=0, padx=10, sticky="we")

vo_rms_label_txt = ttk.Label(root, text="Vo RMS:", style="Modern.TLabel")
vo_rms_label_txt.grid(row=20, column=0, padx=10, sticky="we")

#--------

theta_label_res = ttk.Label(root, text="", style="Modern.TLabel")
theta_label_res.grid(row=12, column=1, padx=10, sticky="we")

beta_label_res = ttk.Label(root, text="", style="Modern.TLabel")
beta_label_res.grid(row=13, column=1, padx=10, sticky="we")

gamma_label_res = ttk.Label(root, text="", style="Modern.TLabel")
gamma_label_res.grid(row=14, column=1, padx=10, sticky="we")

in_label_res = ttk.Label(root, text="", style="Modern.TLabel")
in_label_res.grid(row=15, column=1, padx=10, sticky="we")

irn_label_res = ttk.Label(root, text="", style="Modern.TLabel")
irn_label_res.grid(row=16, column=1, padx=10, sticky="we")

io_avg_label_res = ttk.Label(root, text="", style="Modern.TLabel")
io_avg_label_res.grid(row=17, column=1, padx=10, sticky="we")

io_rms_label_res = ttk.Label(root, text="", style="Modern.TLabel")
io_rms_label_res.grid(row=18, column=1, padx=10, sticky="we")

vo_avg_label_res = ttk.Label(root, text="", style="Modern.TLabel")
vo_avg_label_res.grid(row=19, column=1, padx=10, sticky="we")

vo_rms_label_res = ttk.Label(root, text="", style="Modern.TLabel")
vo_rms_label_res.grid(row=20, column=1, padx=10, sticky="we")

error_label = ttk.Label(root, text="")
error_label.grid(row=21, column=0, padx=10, sticky="w")
...
tk.Label(root, text="Gráfica:", bg="#f0f0f0", fg="#404040", font=("Century Gothic", 16)).grid(row=11, column=0, padx=10, pady=10)
grafica_combo = ttk.Combobox(root, textvariable=grafica_var, values=list(op_CB_2.keys()), state="readonly", font=font_settings)
grafica_combo.grid(row=11, column=1, padx=10, pady=10)
...
radio_halfwave_singlephase.grid(row=0, column=0, padx=10, pady=10)
